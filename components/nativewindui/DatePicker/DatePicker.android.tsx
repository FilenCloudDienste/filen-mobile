			...
			<View className="flex-row gap-2.5">
				{props.mode.includes("date") && (
					<View className={cn("relative pt-1.5", props.materialDateClassName)}>
						...
						<View className={cn("bg-card absolute left-2 top-0 px-1", props.materialDateLabelClassName)}>
							<Text
								variant="caption2"
				...
				{props.mode.includes("time") && (
					<View className={cn("relative pt-1.5", props.materialTimeClassName)}>
						...
						<View className={cn("bg-card absolute left-2 top-0 px-1", props.materialTimeLabelClassName)}>
							<Text
								variant="caption2"
								className="text-[10px] opacity-60"
							>
