...
export function toOnPressMenuItem(onItemPress: DropdownMenuProps["onItemPress"]): OnPressMenuItemEvent {
...
export function toConfigSubMenu(subMenu: DropdownSubMenu): MenuElementConfig {
	if (subMenu.loading) {
		return {
			type: "deferred",
...
export function toConfigItem(item: DropdownItem): MenuElementConfig {
	if (item.loading) {
		return {
			type: "deferred",
