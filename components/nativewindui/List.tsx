...
type ListRenderItem<T extends ListDataItem> = (props: ListRenderItemProps<T>) => ReturnType<FlatlistListRenderItem<T>>
...
const List = React.forwardRef(ListComponent) as <T extends ListDataItem>(props: ListProps<T> & { ref?: ListRef<T> }) => React.ReactElement
