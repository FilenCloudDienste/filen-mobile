					...
					<>
						...
						<SettingsGroup>
							<SettingsButtonLinkHighlight
								...
								onPress={() => {
									Alert.alert(
										i18n(lang, "deleteAllFiles"),
										i18n(lang, "deleteAllFilesInfo"),
										[
											{
													...
													Alert.alert(
														...
														[
															...
															},
															{
																...
																onPress: () => {
																	useStore.setState({
																		fullscreenLoadingModalVisible: true
																	})
							...
							<SettingsButtonLinkHighlight
								...
								onPress={() => {
									Alert.alert(
										i18n(lang, "deleteAllVersionedFiles"),
										i18n(lang, "deleteAllVersionedFilesInfo"),
										[
											{
												text: i18n(lang, "cancel"),
												onPress: () => {
