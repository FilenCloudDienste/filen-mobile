        ...
        <>
            ...
            <ScrollView style={{
                ...
                <SettingsGroup>
                    ...
                    <SettingsButtonLinkHighlight title="Deutsch" onPress={() => {
                        setLang("de")
                    }} />
                    ...
                    <SettingsButtonLinkHighlight title="Nederlands" onPress={() => {
                        setLang("nl")
                    }} />
                    <SettingsButtonLinkHighlight title="Polski" onPress={() => {
                        setLang("pl")
                    }} />
                    ...
                    <SettingsButtonLinkHighlight title="简体字" onPress={() => {
                        setLang("zh")
                    }} />
                    <SettingsButtonLinkHighlight title="Türk" onPress={() => {
                        setLang("tr")
                    }} />
                </SettingsGroup>
