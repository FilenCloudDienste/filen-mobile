...
import { SettingsGroup, SettingsButtonLinkHighlight, SettingsHeader } from "./SettingsScreen"
        ...
        <>
            ...
            <ScrollView style={{
                ...
                <SettingsGroup marginTop={15}>
                    <SettingsHeader navigation={navigation} route={route} navigationEnabled={false} />
                </SettingsGroup>
