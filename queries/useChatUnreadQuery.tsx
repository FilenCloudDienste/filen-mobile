...
export default function useChatUnreadQuery({
	...
	refetchInterval = DEFAULT_QUERY_OPTIONS.refetchInterval,
	enabled
}: {
	...
	const query = useQuery({
		...
		refetchInterval: typeof refetchInterval === "number" ? (refetchInterval > 0 ? refetchInterval : false) : refetchInterval
	})
