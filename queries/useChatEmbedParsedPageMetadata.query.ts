...
export const BASE_QUERY_KEY = "useChatEmbedParsedPageMetadataQuery"

export type UseChatEmbedParsedPageMetadataQueryParams = {
	link: string
}

export async function fetchData(params: UseChatEmbedParsedPageMetadataQueryParams) {
	return await new WebpageMetadataParser(params.link).parseWebpageMetadata()
}

export function useChatEmbedParsedPageMetadataQuery(
...
export default useChatEmbedParsedPageMetadataQuery
